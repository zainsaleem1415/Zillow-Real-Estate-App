...
import BedroomBathroomDropdown from "./BedroomBathroomDropdown";
import HomeTypeDropdown from "./HomeTypeDropdown";
import MoreFiltersDropdown from "./MoreFilterDropdown";
...
const Buy = () => {
  return (
    <div>
      ...
      <div className="flex flex-wrap border border-gray-400 p-[6px] gap-[7px]  justify-center">
        <div className="relative md:w-[43.5rem] w-full mx-2 md:mx-0">
          <div className="absolute inset-y-0 right-2 flex items-center text-gray-500 cursor-pointer">
            <FaSearch />
          </div>
          <input
            type="text"
            placeholder="Address, neighborhood, city, ZIP"
            className="text-gray-500 border border-gray-400 rounded w-full py-2 lg:py-[8px] pl-2 pr-10   text-sm focus:outline-none focus:ring-1 focus:ring-blue-400"
          />
        </div>
        ...
        <HomeTypeDropdown />
        <MoreFiltersDropdown />
        <button className="bg-blue-700  px-4 py-1 rounded hover:bg-white hover:text-blue-700 border border-blue-700  hover:border-blue-700 text-white">
          Save Search
        </button>
      </div>
      {/* Home Details */}
      <div className="flex md:flex-row flex-col flex-1 ml-3 pr-3 md:pr-0">
        {/* For Mob only */}
        ...
        <div className="max-w-[]  ">
          {/* PropertyMap-Image  */}
          <img src="./map.png" alt="" className="rounded md:rounded-none  " />
        ...
        {/* home list-2*/}
        <div className="w-full py-[19px] md:px-3 flex flex-col gap-4">
          <h2 className="text-[19px]">Real Estate & Homes For Sale</h2>
          <div className="flex justify-between w-full  py-3 text-sm ">
            <p>714 results</p>
            <p className="text-blue-700 font-medium">Sort:Homes for you</p>
